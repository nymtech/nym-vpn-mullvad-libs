...
import { CustomListRelayListProvider } from './CustomListRelayListProvider';
...
export default function CustomLists(props: CustomListsProps) {
  ...
  if (searchTerm !== '' && props.customLists.length === 0) {
    return null;
  }
  ...
  return (
    <Cell.Group>
      ...
      <CustomListRelayListProvider customLists={props.customLists}>
        <Accordion expanded>
          <CustomListsImpl
