...
import Foundation
enum SelectLocationSectionGroup: Hashable, CustomStringConvertible, CaseIterable {
    case customLists
    case allLocations
    ...
    static var allCases: [SelectLocationSectionGroup] {
        #if DEBUG
...
extension SelectLocationSectionGroup {
