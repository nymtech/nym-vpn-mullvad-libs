...
private let sampleToken = "12345678"
...
class MaskedInputFormatterTests: XCTestCase {
    ...
    func testInvalidCharactersReplacesTextFieldTextWithFormattedString() {
        ...
        let invalidRange = NSRange(location: sampleToken.count + 1, length: 0)
    ...
    func testDeleteCharacterOutsideOfTokenBoundaryDoesNotDeleteAnything() {
        ...
        let invalidRange = NSRange(location: sampleToken.count + 1, length: 1)
        let textField = UITextField()
    ...
    func testDeleteLastCharacter() {
        ...
        let lastCharacterRange = NSRange(location: sampleToken.count, length: 1)
        let textField = UITextField()
